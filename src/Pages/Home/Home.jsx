  ...
  return (
    <div>
      ...
      <section className="ec-all-products">
              <AllProducts />
              <Link to="/Products" className="ec-btn-more ec-no-underline">See More</Link>
      </section>
        ...
        <div className="invest-grid">
          <div className="invest-card">
            <div className="invest-img">
              <img src="/api/placeholder/400/300" alt="Short Term Investment" />
            </div>
            <h3>Short Term Investment</h3>
            <p>Short term investments on daily/weekly basis to fund what is useful for all.</p>
            <button>Become A Investor</button>
          </div>

          <div className="invest-card">
            <div className="invest-img">
              <img src="/api/placeholder/400/300" alt="Long Term Investment" />
            </div>
            <h3>Long Term Investment</h3>
            <p>Long term investments with better returns to fund what is useful for all.</p>
            <button>Become A Investor</button>
          </div>

          <div className="invest-card">
            <div className="invest-img">
              <img src="/api/placeholder/400/300" alt="Social Impact Investment" />
            </div>
            <h3>Social Impact Investment</h3>
            <p>Social impact investments to help fund what is useful for all.</p>
            <button>Become A Investor</button>
          </div>
        </div>
      </div>
